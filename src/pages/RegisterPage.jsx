...
import SideContent from "../components/Fragments/SideContent";
  ...
  return (
    <>
      <div className="h-screen max-w-full flex mx-auto md:flex items-center justify-center bg-white">
        ...
        {/* Right Side Content */}
        <SideContent rounded="rounded-l-3xl" title={"Find Your Experience "} subHeading={"Join Us Now & get your wish!"} />
      </div>
    </>
  );
};
