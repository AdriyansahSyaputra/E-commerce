  ...
  return (
    <div className="my-20 bg-gradient-to-b from-white to-gray-50">
      <section
        ...
        style={{
          backgroundImage:
            "url('/public/img/banner/about.jpg')",
        }}
      >
        {/* Overlay */}
        ...
        <div className="relative container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-base md:text-xl lg:text-2xl text-white/90 mb-8 leading-relaxed">
              Discover an unparalleled shopping experience tailored for
              Indonesians. From advanced technology to seamless transactions, we
              bring innovation to your fingertips.
            </p>
