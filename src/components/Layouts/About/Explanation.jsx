          ...
          <div className="flex flex-col md:flex-row mt-5 md:mt-10 w-full gap-6">
            <div className="w-full md:w-1/2 p-4">
              ...
              <p className="text-start text-sm md:text-base mt-2 font-extralight text-slate-700">
                ...
                Maiores nostrum perspiciatis eos aut, ipsam totam quas illum non
                magni at sequi voluptatem obcaecati, repellat provident, cum
                iusto! Hic, doloremque labore. Laudantium fugit minima optio
                inventore ratione, modi fugiat quae distinctio in! Recusandae,
                harum provident, eum facilis nam quam est enim dolor neque fuga
                delectus omnis quo aut, fugit sed soluta molestiae esse
                quibusdam magni temporibus nobis cupiditate corporis! Aut sunt
                atque omnis consequuntur nesciunt aliquid.
              </p>
            </div>
