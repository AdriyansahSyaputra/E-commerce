...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Shipping fees depend on your location and the total weight of the order. Standard shipping rates are displayed during checkout. Some products may qualify for free shipping if they meet certain conditions, such as a minimum order amount.",
  },
  {
    id: 4,
    question: " What payment methods do you accept?",
    answer:
      "We accept a wide range of payment methods, including credit cards, debit cards, and PayPal. You can choose your preferred payment method during checkout.",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    answer:
      "You may be able to change your delivery address if the order hasn’t been processed or shipped. Contact our customer support as soon as possible with your updated address. If the order is already in transit, we may not be able to modify the delivery address.",
  },
  {
    id: 10,
    question: "Is my personal information secure on your platform?",
    answer:
      "Yes, we prioritize the security of your personal information. Our website uses advanced encryption methods and complies with data protection regulations. Your payment details are processed securely through trusted payment gateways.",
  },
];
            ...
            <div key={faq.id} className="bg-white rounded-2xl shadow-sm">
              ...
              <div
                className={`overflow-hidden transition-all duration-300 ease-in-out ${
                  openFaq === faq.id ? "opacity-100" : "opacity-0 h-0"
                }`}
              >
